class Livre{
    ...
    // c'est un constructeur de recopie qui prend un livre en parametre
    Livre(Livre l){
 ...
 // la methode toString qui s'occupe de l'affichage d'un livre avec tous les details
    ...
    // c'est une methode qui permet de comparer si deux livres sont identiques ou pas (critere de comparaison titre et auteur)
